...
model.save('C:/Users/Dheeraj Kumar/Downloads/Downloads/Crop-Classification/models/mobileNet.h5')
y_pred = model.predict(test_set)
import numpy as np
y_pred = np.argmax(y_pred, axis=1)
from tensorflow.keras.models import load_model
from tensorflow.keras.preprocessing import image
model=load_model('C:/Users/Dheeraj Kumar/Downloads/Downloads/Crop-Classification/models/mobileNet.h5')
